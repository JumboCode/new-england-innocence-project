...
const AccountInfoComponent: React.FC<AccountInfoProps> = ({ type, userProfilePicture }) => {
    ...
    return (
        <form onSubmit={handleSubmit} style={formStyle}>
            ...
            <input type="text" text-align="center" name="name" placeholder="First Name Last Name" value={user?.fullName} onChange={handleChange} style={inputTextStyle} />

            <label style= {{ color: '#000000' }}>Email:</label>
            <input type="text" name="email" placeholder="email@email.com" value={user?.emailAddresses} onChange={handleChange} style={inputTextStyle} />

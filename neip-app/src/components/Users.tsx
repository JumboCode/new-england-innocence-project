...
const UsersComponent: React.FC<UsersProps> = ({ firstName, lastName, email, type, dateCreated }) => {
    ...
    return (
        <div style={divStyle}>
            ...
            {type === "administration" && <div><span style={typeTextStyle}>Type: </span><span style={adminTypeStyle}>Administration</span></div>}
            {type === "intern" && <span style={internTypeStyle}>Intern</span>}

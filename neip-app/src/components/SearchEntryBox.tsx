      ...
      setExonerees(
        data.map((exoneree: any) => ({
          ...
          falseConfession: exoneree.wrongfulConvictionInfo?.falseConfession
            ? 'Yes'
            : 'No',
          eyewitnessMisidentification: exoneree.wrongfulConvictionInfo
            ?.eyewitnessMisidentification
            ? 'Yes'
            : 'No',
          inadequateLegalDefense: exoneree.wrongfulConvictionInfo
          ...
          forensicEvidence: exoneree.wrongfulConvictionInfo?.forensicEvidence
            ? 'Yes'
            : 'No',
          informantTestimony: exoneree.wrongfulConvictionInfo
            ?.informantTestimony
            ? 'Yes'
            : 'No',
          ...
          educationalBackground:
            exoneree.personalInfo?.educationalBackground || 'N/A',
